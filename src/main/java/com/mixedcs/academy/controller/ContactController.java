...
import com.mixedcs.academy.service.ContactService;
...
public class ContactController {
    ...
    public ModelAndView displayMessages(Model model,
        ...
        Page<Contact> messagePage = contactService.findMessageWithOpenStatus(pageNum,sortField,sortDir);
        List<Contact> contactMessage = messagePage.getContent();
        ModelAndView modelAndView = new ModelAndView("messages.html");
        model.addAttribute("currentPage", pageNum);
        model.addAttribute("totalPages", messagePage.getTotalPages());
        model.addAttribute("totalMessage", messagePage.getTotalElements());
        model.addAttribute("sortField", sortField);
        model.addAttribute("sortDir", sortDir);
        model.addAttribute("reverseSortDir", sortDir.equals("asc") ? "desc" : "asc");
        modelAndView.addObject("contactMessage",contactMessage);
        return modelAndView;
    }
